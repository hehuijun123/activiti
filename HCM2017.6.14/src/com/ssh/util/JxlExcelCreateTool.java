...
*/
    public static void writeExcel(Map<String,List<Storehouse>> map) throws Exception {
        // 第一步创建excel文件,并决定excel的路径和文件名
    	
    	String name = "E:/excel/"+Name(map)+"-"+GetDate.Getdate()+".xls";
    	String Ename = Name(map)+"-"+GetDate.Getdate();//文件名
    	String sc = ID(map);
        ...
        sheet.addCell(new Label(1, 1, Name(map), contentFormat2));
