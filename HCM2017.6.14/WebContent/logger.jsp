...
<div class="bg">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="bread">
      ...
      <li><a href="##" id="a_leader_txt">日志管理</a></li>
    </ul>
    ...
    <section class="list_data"">
			<table id="dg" title="" class="easyui-datagrid" border="0" cellspacing="0" style="width:88%;text-align: center;"
					data-options="toolbar:'#toolbar',pagination:true,singleSelect:true,
                        url:'User_selectLog.action',pageSize:10,pageList:[10,20,30]">
					<thead>
						<tr>
							<th field="ldate"    width="33%">日期</th>
							<th field="luser"  width="33%">用户</th>
							<th field="lcontains"  width="33%">操作</th>
