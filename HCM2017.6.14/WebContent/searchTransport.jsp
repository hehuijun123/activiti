 ...
 <div class="toparticle">
   ...
   <aside class="main-sidebar">
    ...
    <ul class="bread">
      ...
      <li><a href="##" id="a_leader_txt">运输查询</a></li>
    </ul>
    ...
    <section class="list_data"">
			<table id="dg" title="" class="easyui-datagrid" border="0" cellspacing="0" style="width:88%;text-align: center;"
					data-options="toolbar:'#toolbar',pagination:true,singleSelect:true,
                        url:'Transport_searchPurchase.action',pageSize:10,pageList:[10,20,30]">
					<thead>
						<tr>
							<th field="tnum"  align="center"   width="17%">订单号</th>
							<th field="tdate"   align="center"  width="17%">送货日期</th>
							<th field="tcompany" align="center"  width="17%">送货单位</th>
							<th field="tperson"  align="center" width="17%">送货人</th>
														<th field="tr" align="center"  width="11%">记录人</th>
							
							<th field="tother"  align="center" width="17%">接收人</th>
				...
				<div id="toolbar">
				    <div class="content">
				    			订单号:
				   							<input name="tnum" id="tnum" class="easyui-validatebox" validType="true" style="margin-left:10px;">
							   	起始时间:
