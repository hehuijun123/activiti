...
$(function(){
	var wname=$("#param1").val();
	var cname=$("#param2").val();
	console.log(wname+cname)
	 $('#dg').datagrid({
			url:'Waste_searchPurchasesc.action?cname='+cname+'&wname='+wname,
			pagination:true,
			singleSelect:true,
			pageSize:10,
			pageList:[10,20,30],
			columns:[[
				{title:'水厂',field:"cname",width:'15%',align:'center'},
					{title:'废弃物类型',field:"wname",width:'15%',align:'center'},
					{title:'时间',field:"wdate",width:'15%',align:'center'},
					{title:'数量',field:"wnum",width:'15%',align:'center'},
					{title:'接收单位',field:"wcompany",width:'15%',align:'center'},
					{title:'处置人',field:"wperson",width:'15%',align:'center'},
					{title:'记录单位/人',field:"wr",width:'11%',align:'center'},	
			]]
		}); 
...
<div class="bg">
   ...
   <aside class="main-sidebar">
    ...
    <ul class="bread">
     ...
     <div><input type="hidden" id="param1" value='${param.wname }' /></div>
      <div><input type="hidden" id="param2" value='${param.cname }' /></div>
    <section class="list_data">
				 ...
				 <div style="color:blue">${param.cname } </div>
