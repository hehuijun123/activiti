  ...
  <div class="toparticle">
   ...
   <aside class="main-sidebar">
    ...
    <ul class="bread">
      ...
      <li><a href="##" id="a_leader_txt">入库查询</a></li>
    </ul>
    ...
    <section class="list_data">
			<table id="dg" title="" class="easyui-datagrid" border="0" cellspacing="0" style="width:88%;text-align: center;"
					data-options="toolbar:'#toolbar',pagination:true,singleSelect:true,
                        url:'Purchase_searchPurchase.action',pageSize:10,pageList:[10,20,30]">
					<thead>
						<tr>
							<th field="pname" align="center"    width="11%">危化物</th>
							<th field="pcompany" align="center"  width="11%">公司</th>
							<th field="ptype" align="center"  width="11%">类别</th>
							
							<th field="pnum"  align="center" width="11%">数量</th>
							<th field="punit"  align="center" width="11%">数量</th>
							<th field="pdate"  align="center" width="11%">入库日期</th>
							<th field="ppoison" align="center"  width="11%">剧毒品及易制毒</th>
							<th field="papplydate" align="center"  width="11%">申报时间</th>
