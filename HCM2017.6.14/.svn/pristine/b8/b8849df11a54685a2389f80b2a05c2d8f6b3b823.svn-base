    ...
    <section class="list_data">
			<table id="dg" title="" class="easyui-datagrid" border="0" cellspacing="0" style="width:88%;text-align: center;"
					data-options="toolbar:'#toolbar',pagination:true,singleSelect:true,
                        url:'Emergency_selectEmergency.action?flax=Einstructions',pageSize:10,pageList:[10,20,30]">
					<thead>
						<tr>
							<th field="einstructions" align="center"    width="33%">技术说明</th>
							<th field="edate" align="center"    width="33%">上传日期</th>
							<th field="eperson" align="center"    width="33%">上传人</th>
